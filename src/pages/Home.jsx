          ...
          <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-12">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center space-y-6" data-aos="fade-up">
              ...
              <div className="flex justify-center space-x-6 mt-4">
                <a href="https://github.com/yourusername" className="hover:text-gray-400"><FaGithub size={30} /></a>
                <a href="https://linkedin.com/in/yourusername" className="hover:text-gray-400"><FaLinkedin size={30} /></a>
                <a href="mailto:vedantsonavane799@gmail.com" className="hover:text-gray-400"><FaEnvelope size={30} /></a>
              </div>
              ...
              <div className="mt-6 text-center">
                ...
                <p className="mt-2 text-lg"><strong>Phone:</strong> +1 (123) 456-7890</p>
                <p className="mt-2 text-lg"><strong>Address:</strong> 123 Your Street, Your City, Country</p>
              </div>
            </div>
          </div>
        </section>
