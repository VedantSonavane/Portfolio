    ...
    <footer className="relative text-white pt-16 w-full">
      <div className="w-full bg-white bg-opacity-20 backdrop-blur-lg p-8 md:p-12 lg:p-16  border border-white border-opacity-30 shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="flex items-center gap-2 text-sm md:text-base">
              <FaEnvelope /> vedantsonavane799@gmail.com
            </p>
            <p className="flex items-center gap-2 text-sm md:text-base">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          {[FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaGithub].map((Icon, index) => (
            <a key={index} href="#" className="text-white hover:text-white transition duration-300">
